# -*- coding: utf-8 -*-
"""
Created on Mon Mar  1 20:06:43 2021
...
if __name__ == "__main__":
    ...
    test_loss, test_acc = compute_loss_and_accuracy(trainer.dataloader_val, trainer.model, trainer.loss_criterion)
    print(f"test loss: {test_loss}\ntest accuracy: {test_acc}\n")
    create_plots(trainer, "task4b")
