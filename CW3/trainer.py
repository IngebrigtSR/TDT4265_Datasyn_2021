...
def compute_loss_and_accuracy(
    ...
    # Change total_Loss to a torch tensor to work?
    total_loss = torch.Tensor(total_loss)
    # Computing average loss from total loss
...
class Trainer:
    ...
    def validation_step(self):
        ...
        self.TEST_ACC["test_loss"][self.global_step] = test_acc
        self.TEST_LOSS["test_acc"][self.global_step] = test_loss
